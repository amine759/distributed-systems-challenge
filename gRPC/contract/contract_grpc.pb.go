...
func (c *chatServiceClient) SayHello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedChatServiceServer) SayHello(context.Context, *Request) (*Response, error) {
